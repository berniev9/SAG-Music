...
def create_database(cur, conn):
    cur.execute('CREATE TABLE IF NOT EXISTS Billboard (Rank INTEGER PRIMARY KEY, Song TEXT, Artist TEXT, Previous Rank INTEGER, Peak Rank INTEGER, Weeks on Charts INTEGER)')
    conn.commit()
